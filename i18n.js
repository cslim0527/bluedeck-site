...
const I18N = {
  ...
  ko: {
    ...
    "feat.status.d": "각 패널을 <b style=\"color:var(--green)\">working</b> / <b style=\"color:var(--amber)\">needs-input</b> / <b style=\"color:var(--ink-3)\">idle</b>로 추적합니다. 백그라운드 상태에서는 macOS 알림으로 손이 필요한 순간을 알려줍니다. <kbd>⌘J</kbd> 한 번으로 입력이 필요한 터미널로 바로 이동합니다.",
