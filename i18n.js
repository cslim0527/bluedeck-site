...
const I18N = {
  en: {
    ...
    "hero.note": "<b>Public beta</b> — every feature free through Aug 31, 2026 · no sign-up, no credit card",
    ...
    "price.pro.betacta": "Free during the beta — download",
    "price.note": "During the beta every download is fully unlocked — no license key needed. When the beta ends (Aug 31, 2026) a fresh 14-day trial starts for everyone, and Pro pricing goes live.",
    ...
    "dlpage.badge": "Public beta · every feature free through Aug 31, 2026",
    "dlpage.h1": "Download BlueDeck",
    "dlpage.sub": "Choose your platform. Every download is fully unlocked during the beta.",
  ...
  ko: {
    ...
    "hero.note": "<b>공개 베타</b> — 2026년 8월 31일까지 전 기능 무료 · 가입/카드 불필요",
    "deck.sidebar": "⌘B 사이드바",
    ...
    "price.pro.betacta": "베타 기간 무료 — 다운로드",
    "price.note": "베타 기간에는 모든 다운로드가 완전히 개방됩니다 — 라이선스 키가 필요 없습니다. 베타가 끝나면(2026년 8월 31일) 모두에게 새 14일 트라이얼이 시작되고 Pro 가격이 적용됩니다.",
    "dl.h2": "지금 바로 덱을 펼치세요",
    ...
    "dlpage.back": "← 홈으로",
    "dlpage.badge": "공개 베타 · 2026년 8월 31일까지 전 기능 무료",
    "dlpage.h1": "BlueDeck 다운로드",
    "dlpage.sub": "플랫폼을 선택하세요. 베타 기간에는 모든 다운로드가 완전히 개방됩니다.",
    "dlpage.mac.name": "macOS",
    "dlpage.mac.sub": "Apple Silicon · .dmg",
